...
function creerUtilisateur(nomUtilisateur, soldeInitial) {
    ...
    console.log("l'utilisateur : " + nomUtilisateur + " a bien été crée.");
}
...
//2.Créez une fonction nommée effectuerTransaction qui prend le nom de l'utilisateur, un montant et une fonction de rappel (callback) en tant que paramètres.

function effectuerTransaction (nomUtilisateur,montant,operation) {

    
    console.log("Transaction : " );
    operation(nomUtilisateur,montant);
}

effectuerTransaction("Peter",300, crediterCompte);
creerUtilisateur("Marius", 15);
afficherInfoUtilisateur("Marius");